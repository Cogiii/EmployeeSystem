    ...
    private void validateAndLogin(Stage window) {
        ...
        if (isAuthenticated) {
            if ("deleted".equals(status)) {
                ...
                attendance.record(userID, "time in");
                ...
                switch (status) {
                    ...
                    case "admin":
                        ...
                        break;
                    default:
                        showAlertError("Invalid status", "The user status is invalid.");
                        break;
                }
            }
        } else {
            showAlertError("Invalid credentials", "Invalid credentials. Please try again.");
        }
